...
public class CriarTipoAtividade extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CriarTipoAtividade.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Criar Tipo de Atividade");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TipoAtividade ta = new TipoAtividade(0, nome, descricao);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CriarTipoAtividade().setVisible(true));
    }
